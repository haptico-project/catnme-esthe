import{s as i,n as a,d as o,i as p,a as c,c as m,g as b,e as d}from"../chunks/C5q2LRfO.js";import{S as x,i as h}from"../chunks/RdRI2tdk.js";import{b as s}from"../chunks/CyvZyKtN.js";function f(n){let e,r=`<main class="mx-auto max-w-phone px-4 pb-20 pt-10"><header class="mb-8"><a href="${`${s}/`}" class="text-sm text-gray-600 hover:underline">トップへ戻る</a> <h1 class="text-2xl font-semibold mt-4">プライバシーポリシー</h1></header> <section class="text-sm leading-relaxed"><p class="mb-4">株式会社ファセテラピー（以下「当社」といいます）は、当社が提供する本ウェブサイトおよび関連サービス（以下「本サービス」といいます）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。</p> <p class="mb-4">第1条（個人情報の定義）<br/>
