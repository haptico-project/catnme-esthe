import{s as o,n as a,d as p,i as c,a as i,c as m,g as b,e as d}from"../chunks/C4I-M22S.js";import{S as x,i as h}from"../chunks/CHiqxq2f.js";import{b as s}from"../chunks/2IF1AQH_.js";function f(n){let e,r=`<main class="mx-auto max-w-phone px-4 pb-20 pt-10"><header class="mb-8"><a href="${`${s}/`}" class="text-sm text-gray-600 hover:underline">トップへ戻る</a> <h1 class="text-2xl font-semibold mt-4">プライバシーポリシー</h1></header> <section class="text-sm leading-relaxed"><p class="mb-4">株式会社ファセテラピー（以下「当社」といいます）は、当社が提供する本ウェブサイトおよび関連サービス（以下「本サービス」といいます）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。</p> <p class="mb-4">第1条（個人情報の定義）<br/>
