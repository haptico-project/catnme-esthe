import{s as o,n as a,d as p,i as c,a as i,c as m,g as b,e as d}from"../chunks/C5q2LRfO.js";import{S as x,i as h}from"../chunks/RdRI2tdk.js";import{b as s}from"../chunks/i6PlMvOf.js";function f(n){let e,r=`<main class="mx-auto max-w-phone px-4 pb-20 pt-10"><header class="mb-8"><a href="${`${s}/`}" class="text-sm text-gray-600 hover:underline">トップへ戻る</a> <h1 class="text-2xl font-semibold mt-4">プライバシーポリシー</h1></header> <section class="text-sm leading-relaxed"><p class="mb-4">株式会社ファセテラピー（以下「当社」といいます）は、当社が提供する本ウェブサイトおよび関連サービス（以下「本サービス」といいます）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。</p> <p class="mb-4">第1条（個人情報の定義）<br/>
				...
				株式会社ファセテラピー／住所：〒150-0002 東京都渋谷区渋谷1丁目15-15-1010／メール: tft.kao@gmail.com／電話番号: 03-3818-0408</p></section> <footer class="text-sm text-gray-600 mt-16"><div class="bg-white/70 border border-gray-200 rounded-3xl px-6 py-12"><div class="flex flex-wrap items-center justify-center gap-5 mb-6 text-sm"><a href="${`${s}/terms`}" class="hover:underline">利用規約</a> <a href="${`${s}/tokusho`}" class="hover:underline">特定商取引法に基づく表記</a> <a href="${`${s}/privacy`}" class="hover:underline">プライバシーポリシー</a></div> <p class="text-center text-ink/80 font-semibold">株式会社ファセテラピー</p> <p class="text-center">〒150-0002 東京都渋谷区渋谷1丁目15-15-1010</p> <p class="text-center text-xs text-gray-500 mt-4">お問い合わせはメールにて承っております。</p></div></footer></main>`;return{c(){e=d("div"),e.innerHTML=r,this.h()},l(t){e=m(t,"DIV",{class:!0,"data-svelte-h":!0}),b(e)!=="svelte-1or4oqp"&&(e.innerHTML=r),this.h()},h(){i(e,"class","w-full bg-basebg text-ink")},m(t,l){c(t,e,l)},p:a,i:a,o:a,d(t){t&&p(e)}}}function u(n,e,r){return[!0]}class y extends x{constructor(e){super(),h(this,e,u,f,o,{prerender:0})}get prerender(){return this.$$.ctx[0]}}export{y as component};
